...
TEST( EthereumKeyGeneratorTest, PrivateKeyGenerated )
{
    ...
    // Assert
    EXPECT_TRUE( !privkey.pubkey_data().X.is_zero() );
}
...
TEST( EthereumKeyGeneratorTest, EthereumKeyImportTest )
{
    ...
    EXPECT_EQ( key_generator.GetUsedPubKeyValue(), "b8c611cdf2c0afc59afab613b89da83464284928b482c0b604b2a99642cb4d06b3325e5990b7fabc60b739f44657774f96cd10417506e3143059a34da07af45d" );
