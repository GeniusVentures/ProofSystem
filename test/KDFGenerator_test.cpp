...
TEST( KDFGeneratorTest, KDFGeneratorETHSecretCreation )
{
    ...
    EthereumKeyGenerator proover_instance;
    EthereumKeyGenerator sgnus_instance;

    KDFGenerator<ethereum::policy_type> KDFInstance_Proover( proover_instance.get_private_key(), sgnus_instance.GetEntirePubValue() );
...
TEST( KDFGeneratorTest, KDFGeneratorETHDeterministic )
{
    ...
    EthereumKeyGenerator proover_instance( "0110289C284E4665ADA21969A38525AC21B76D298CDBE6B28954EE3BD87E4628" );
    EthereumKeyGenerator sgnus_instance( "9903EB9091DA5DB623140763AC443A69348A8A2CC52DC88029ACB4DD716A74E8" );

    EthereumKeyGenerator proover_instance_copy( "0110289C284E4665ADA21969A38525AC21B76D298CDBE6B28954EE3BD87E4628" );
    EthereumKeyGenerator sgnus_instance_copy( "9903EB9091DA5DB623140763AC443A69348A8A2CC52DC88029ACB4DD716A74E8" );

    KDFGenerator<ethereum::policy_type> KDFInstance_orig( proover_instance.get_private_key(), sgnus_instance.GetEntirePubValue() );
    KDFGenerator<ethereum::policy_type> KDFInstance_copy( proover_instance_copy.get_private_key(), sgnus_instance_copy.GetEntirePubValue() );
...
TEST( KDFGeneratorTest, KDFGeneratorETH_ECDHSessionKey )
{
    ...
    KDFGenerator<ethereum::policy_type>  KDFInstance_Proover( proover_instance.get_private_key(), sgnus_instance.GetEntirePubValue() );
    KDFGenerator<ethereum::policy_type>  KDFInstance_Revealer( sgnus_instance.get_private_key(), proover_instance.GetEntirePubValue() );
    ...
    delete ( KDFInstance_Intruder );
    KDFInstance_Intruder = new KDFGenerator<ethereum::policy_type>( intruder_instance.get_private_key(), proover_instance.GetEntirePubValue() );
    EXPECT_FALSE( KDFInstance_Revealer == ( *KDFInstance_Intruder ) );
    delete ( KDFInstance_Intruder );
    KDFInstance_Intruder = new KDFGenerator<ethereum::policy_type>( sgnus_instance.get_private_key(), proover_instance.GetEntirePubValue() );
    EXPECT_TRUE( KDFInstance_Revealer == ( *KDFInstance_Intruder ) );
    delete ( KDFInstance_Intruder );
}
...
TEST( KDFGeneratorTest, KDFGeneratorNewEthereum )
{
    ...
    KDFGenerator<ethereum::policy_type> *KDF = new KDFGenerator<ethereum::policy_type>( proover_key, sgnus_pubkey_data );
