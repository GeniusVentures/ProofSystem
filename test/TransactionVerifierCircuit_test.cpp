...
TEST( TransactionVerifierCircuitTest, ValidateTransactionPass )
{
    ...
    EXPECT_TRUE( ValidateTransaction( balance, amount, balance_commitment, amount_commitment, expected_new_balance_commitment, generator, ranges,
...
TEST( TransactionVerifierCircuitTest, ValidateTransactionFailNegativeBalance )
{
    ...
    EXPECT_FALSE( ValidateTransaction( balance, amount, balance_commitment, amount_commitment, expected_new_balance_commitment, generator, ranges,
                                       base_seed, provided_totp ) );
}
