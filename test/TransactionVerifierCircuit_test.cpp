...
TEST(TransactionVerifierCircuitTest, ValidateTransactionPass) {
    ...
    typename pallas::base_field_type::value_type base_seed = 12345; // Example seed for TOTP
    typename pallas::base_field_type::value_type provided_totp = 67890; // Example provided TOTP
    std::array<typename pallas::base_field_type::value_type, MAX_RANGES> ranges = {1000, 2000, 3000, 4000};
